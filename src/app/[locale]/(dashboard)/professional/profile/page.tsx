      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
        ...
        <div className="lg:col-span-3 flex flex-col gap-5 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="profile-username" className="text-sm font-medium text-gray-700">
              {t("fields.username")} <span className="font-normal text-gray-400">{t("fields.usernameNote")}</span>
            </label>
          ...
          <Input
            ...
            placeholder={t("fields.specialityPlaceholder")}
            maxLength={60}
          />
          ...
          <div className="flex flex-col gap-1.5">
            ...
            />
            <div className="flex justify-between">
              <p className="text-xs text-gray-400">{t("fields.taglineHint")}</p>
        ...
        <div className="lg:col-span-2 flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1.5 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-gray-200">
            <p className="text-xs font-medium text-gray-500">{t("preview.linkLabel")}</p>
          ...
          <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-200">
            <p className="mb-3 text-xs text-gray-400 font-medium">
              {t("preview.customerView")}
            </p>
            <div className="flex items-start gap-3">
              <Avatar name={name || profile?.name} image={profile?.image} size="lg" />
              <div className="flex-1 min-w-0">
                <p className="font-bold text-gray-900 text-base leading-snug">
                  {name || <span className="text-gray-300 italic">{t("preview.yourName")}</span>}
                </p>
                {speciality ? (
                  <div className="mt-1">
